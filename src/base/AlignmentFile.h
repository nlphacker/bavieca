...
class AlignmentFile {
	...
	public:
		...
		inline static void destroyPhoneAlignment(VPhoneAlignment *vPhoneAlignment) {
		...
		inline static void destroyLexUnitAlignment(VLexUnitAlignment *vLexUnitAlignment) {
