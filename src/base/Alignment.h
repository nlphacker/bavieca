...
// alignment type
#define ALIGNMENT_TYPE_FORWARD_BACKWARD		0
#define ALIGNMENT_TYPE_VITERBI					1
...
class Alignment {
	...
	public:
		...
		// add frame alignment
		void addFrameAlignment(VStateOcc *vStateOcc);
		
		// add a lex-unit alignment
		void addLexUnitAlignment(int iFrameBegin, int iFrameEnd, LexUnit *lexUnit);
