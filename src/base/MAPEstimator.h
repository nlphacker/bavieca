...
class MAPEstimator {
	...
	private:	
		...
		bool estimateParameters(HMMState *hmmState, Accumulator **accumulators, float fPriorKnowledgeWeight);
	...
	public:
		...
		bool estimateParameters(MAccumulatorPhysical &mAccumulator, float fPriorKnowledgeWeight);
