...
class WFSADecoder {
	...
	private:
		...
		ConfigurationDecoder *m_configurationDecoder;
		PhoneSet *m_phoneSet;
	...
	public:
		...
		// constructor
		WFSADecoder(ConfigurationDecoder *configurationDecoder, PhoneSet *phoneSet, HMMManager *hmmManager,
			LexiconManager *lexiconManager, WFSAcceptor *wfsAcceptor, Log *log, 
		...
		bool initializeViterbi();	
		
		// perform Viterbi search
		bool viterbi(float *fFeatureVectors, unsigned int iFeatureVectors);
